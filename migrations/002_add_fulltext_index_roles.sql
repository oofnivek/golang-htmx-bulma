-- Migration: Add FULLTEXT n-gram index on roles.name
...
-- allowing searches like "admin" to match "Administrator" without a full table scan.
--
...
ALTER TABLE roles
    ADD FULLTEXT INDEX idx_role_name_ngram (name) WITH PARSER ngram;
