...
func TestCreate(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		mock.ExpectExec(regexp.QuoteMeta("INSERT INTO vehicle_color (name, status, created_by, created_at) VALUES (?, ?, ?, ?)")).
			WithArgs(color.Name, color.Status, color.CreatedBy, color.CreatedAt).
